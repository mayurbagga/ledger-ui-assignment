      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div className="bg-gradient-to-br from-green-50 to-green-100/50 dark:from-green-950/50 dark:to-green-900/30 rounded-lg p-3 border">
            ...
            <p className="text-base font-bold text-green-800 dark:text-green-200 font-mono">
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100/50 dark:from-red-950/50 dark:to-red-900/30 rounded-lg p-3 border">
            ...
            <p className="text-base font-bold text-red-800 dark:text-red-200 font-mono">
              ...
              {balances.map((balance) => (
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="font-medium text-sm">{balance.account}</span>
                  </div>
                  <Badge
                    variant={balance.balance >= 0 ? 'default' : 'destructive'}
